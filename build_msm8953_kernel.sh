...
elif [ "$BUILD_COMMAND" == "c7prolte_chn" ]; then
	BUILD_PRODUCT=c7prolte_chn
	PRODUCT_NAME=c7proltechn
	SIGN_MODEL=SM-C7010_CHN_CHC_ROOT0
	USE_FINGERPRINT_TZ="true"
	KASLR_DEFCONFIG=kaslr_defconfig
elif [ "$BUILD_COMMAND" == "c5prolte_chn" ]; then
	BUILD_PRODUCT=c5prolte_chn
	PRODUCT_NAME=c5proltechn
	SIGN_MODEL=SM-C5010_CHN_CHC_ROOT0
	USE_FINGERPRINT_TZ="true"
	KASLR_DEFCONFIG=kaslr_defconfig	
